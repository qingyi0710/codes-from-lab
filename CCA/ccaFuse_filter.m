function [trainZ,testZ] = ccaFuse(trainX, trainY, testX, testY, mode,FilterValue)
...
eigVals = eigVals/maxEigVal ; % 特征值归一化
zeroEigIdx = find(eigVals<FilterValue); 
...
eigVals = eigVals/maxEigVal; % 特征值归一化
zeroEigIndex = find(eigVals<FilterValue);
